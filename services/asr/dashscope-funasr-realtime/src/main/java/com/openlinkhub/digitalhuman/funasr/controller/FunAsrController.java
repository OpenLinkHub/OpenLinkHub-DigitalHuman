package com.openlinkhub.digitalhuman.funasr.controller;

import com.openlinkhub.digitalhuman.funasr.dto.FunAsrRecognitionResponse;
import com.openlinkhub.digitalhuman.funasr.service.FunAsrRealtimeService;
...
public class FunAsrController {
    ...
    @GetMapping("/health")
    @Operation(summary = "健康检查", description = "检查 dashscope-funasr-realtime 服务是否可用。")
    public Map<String, String> health() {
        return Map.of("status", "ok", "service", "dashscope-funasr-realtime");
    }
